...
\caption{Edge-colored Heisenberg-HVA ansatz circuit.  The weighted-RVB initializer is followed by repeated color blocks $G_c(\theta_{\ell,c})$.  Each color block is a product of disjoint two-qubit Heisenberg interactions, decomposed into Qiskit Pauli rotation gates $R_{XX}(2\theta)$, $R_{YY}(2\theta)$, and $R_{ZZ}(2\theta)$.}
