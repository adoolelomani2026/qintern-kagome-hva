...
\begin{figure}[H]
\centering
\includegraphics[width=0.70\linewidth]{bond_map_weighted_rvb.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\linewidth]{one_page_summary.png}
...
\]
This tests whether calibration information can guide circuit expressibility without becoming Hamiltonian calibration \cite{ahsan2026}.  Figure~\ref{fig:calibration-landscape} explains why this next step is interesting: calibrated reference states can sit much closer to the exact target, so the sensitive local regions found by those scans may be useful circuit-design hints.

\begin{figure}[H]
\centering
\includegraphics[width=0.46\linewidth]{calibration_energy_vs_fidelity.png}
\caption{Calibration scan landscape compared with the no-calibration HVA baseline.  These exact reference states are interpreted here as guidance for future ansatz design, not as a replacement for the no-calibration circuit workflow.}
